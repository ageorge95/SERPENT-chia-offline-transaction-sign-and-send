...
try: sys.path.append(path.join(sys._MEIPASS, 'gold_blockchain'))
except: sys.path.append(path.join(path.dirname(__file__), 'gold_blockchain'))
...
from blspy import G1Element,\
    ...
    G2Element,\
    PublicKeyMPL
from gold_blockchain.chia.consensus.cost_calculator import calculate_cost_of_program
from gold_blockchain.chia.consensus.default_constants import DEFAULT_CONSTANTS
from gold_blockchain.chia.full_node.bundle_tools import simple_solution_generator
from gold_blockchain.chia.full_node.mempool_check_conditions import get_name_puzzle_conditions
from gold_blockchain.chia.rpc.full_node_rpc_client import FullNodeRpcClient
from gold_blockchain.chia.types.announcement import Announcement
from gold_blockchain.chia.types.blockchain_format.coin import Coin
from gold_blockchain.chia.types.blockchain_format.program import Program, SerializedProgram
from gold_blockchain.chia.types.coin_record import CoinRecord
from gold_blockchain.chia.types.coin_solution import CoinSolution
from gold_blockchain.chia.types.condition_opcodes import ConditionOpcode
from gold_blockchain.chia.types.blockchain_format.sized_bytes import bytes32
from gold_blockchain.chia.types.spend_bundle import SpendBundle
from gold_blockchain.chia.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
from gold_blockchain.chia.util.condition_tools import parse_sexp_to_conditions
from gold_blockchain.chia.util.config import load_config
from gold_blockchain.chia.util.ints import uint16, uint64
from gold_blockchain.chia.util.hash import std_hash
from gold_blockchain.chia.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from gold_blockchain.chia.util.keychain import mnemonic_to_seed
from gold_blockchain.chia.util.byte_types import hexstr_to_bytes
from gold_blockchain.chia.wallet.wallet import Wallet
from gold_blockchain.chia.wallet.derive_keys import master_sk_to_farmer_sk
from gold_blockchain.chia.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    puzzle_for_pk,
