...
try: sys.path.append(path.join(sys._MEIPASS, 'chives_blockchain'))
except: sys.path.append(path.join(path.dirname(__file__), 'chives_blockchain'))
...
from blspy import G1Element,\
    ...
    G2Element,\
    PublicKeyMPL
from chives_blockchain.chives.consensus.cost_calculator import calculate_cost_of_program
from chives_blockchain.chives.consensus.default_constants import DEFAULT_CONSTANTS
from chives_blockchain.chives.full_node.bundle_tools import simple_solution_generator
from chives_blockchain.chives.full_node.mempool_check_conditions import get_name_puzzle_conditions
from chives_blockchain.chives.rpc.full_node_rpc_client import FullNodeRpcClient
from chives_blockchain.chives.types.announcement import Announcement
from chives_blockchain.chives.types.blockchain_format.coin import Coin
from chives_blockchain.chives.types.blockchain_format.program import Program, SerializedProgram
from chives_blockchain.chives.types.coin_record import CoinRecord
from chives_blockchain.chives.types.coin_solution import CoinSolution
from chives_blockchain.chives.types.condition_opcodes import ConditionOpcode
from chives_blockchain.chives.types.blockchain_format.sized_bytes import bytes32
from chives_blockchain.chives.types.spend_bundle import SpendBundle
from chives_blockchain.chives.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
from chives_blockchain.chives.util.condition_tools import parse_sexp_to_conditions
from chives_blockchain.chives.util.config import load_config
from chives_blockchain.chives.util.ints import uint16, uint64
from chives_blockchain.chives.util.hash import std_hash
from chives_blockchain.chives.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from chives_blockchain.chives.util.keychain import mnemonic_to_seed
from chives_blockchain.chives.util.byte_types import hexstr_to_bytes
from chives_blockchain.chives.wallet.wallet import Wallet
from chives_blockchain.chives.wallet.derive_keys import master_sk_to_farmer_sk
from chives_blockchain.chives.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    puzzle_for_pk,
...
class SERPENT_back_end():
    ...
    def _compute_sks(
        ...
        try:
            ...
            self.intermediate_sk: PrivateKey = AugSchemeMPL.derive_child_sk(self.intermediate_sk, 9699)
