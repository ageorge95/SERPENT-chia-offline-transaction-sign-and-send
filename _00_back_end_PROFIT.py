...
try: sys.path.append(path.join(sys._MEIPASS, 'profit_blockchain'))
except: sys.path.append(path.join(path.dirname(__file__), 'profit_blockchain'))
...
from blspy import G1Element,\
    ...
    G2Element,\
    PublicKeyMPL
from profit_blockchain.profit.consensus.cost_calculator import calculate_cost_of_program
from profit_blockchain.profit.consensus.default_constants import DEFAULT_CONSTANTS
from profit_blockchain.profit.full_node.bundle_tools import simple_solution_generator
from profit_blockchain.profit.full_node.mempool_check_conditions import get_name_puzzle_conditions
from profit_blockchain.profit.rpc.full_node_rpc_client import FullNodeRpcClient
from profit_blockchain.profit.types.announcement import Announcement
from profit_blockchain.profit.types.blockchain_format.coin import Coin
from profit_blockchain.profit.types.blockchain_format.program import Program, SerializedProgram
from profit_blockchain.profit.types.coin_record import CoinRecord
from profit_blockchain.profit.types.coin_solution import CoinSolution
from profit_blockchain.profit.types.condition_opcodes import ConditionOpcode
from profit_blockchain.profit.types.blockchain_format.sized_bytes import bytes32
from profit_blockchain.profit.types.spend_bundle import SpendBundle
from profit_blockchain.profit.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
from profit_blockchain.profit.util.condition_tools import parse_sexp_to_conditions
from profit_blockchain.profit.util.config import load_config
from profit_blockchain.profit.util.ints import uint16, uint64
from profit_blockchain.profit.util.hash import std_hash
from profit_blockchain.profit.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from profit_blockchain.profit.util.keychain import mnemonic_to_seed
from profit_blockchain.profit.util.byte_types import hexstr_to_bytes
from profit_blockchain.profit.wallet.wallet import Wallet
from profit_blockchain.profit.wallet.derive_keys import master_sk_to_farmer_sk
from profit_blockchain.profit.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    puzzle_for_pk,
