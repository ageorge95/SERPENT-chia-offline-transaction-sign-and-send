...
try: sys.path.append(path.join(sys._MEIPASS, 'ethgreen_blockchain'))
except: sys.path.append(path.join(path.dirname(__file__), 'ethgreen_blockchain'))
...
from blspy import G1Element,\
    ...
    G2Element,\
    PublicKeyMPL
from ethgreen_blockchain.ethgreen.consensus.cost_calculator import calculate_cost_of_program
from ethgreen_blockchain.ethgreen.consensus.default_constants import DEFAULT_CONSTANTS
from ethgreen_blockchain.ethgreen.full_node.bundle_tools import simple_solution_generator
from ethgreen_blockchain.ethgreen.full_node.mempool_check_conditions import get_name_puzzle_conditions
from ethgreen_blockchain.ethgreen.rpc.full_node_rpc_client import FullNodeRpcClient
from ethgreen_blockchain.ethgreen.types.announcement import Announcement
from ethgreen_blockchain.ethgreen.types.blockchain_format.coin import Coin
from ethgreen_blockchain.ethgreen.types.blockchain_format.program import Program, SerializedProgram
from ethgreen_blockchain.ethgreen.types.coin_record import CoinRecord
from ethgreen_blockchain.ethgreen.types.coin_solution import CoinSolution
from ethgreen_blockchain.ethgreen.types.condition_opcodes import ConditionOpcode
from ethgreen_blockchain.ethgreen.types.blockchain_format.sized_bytes import bytes32
from ethgreen_blockchain.ethgreen.types.spend_bundle import SpendBundle
from ethgreen_blockchain.ethgreen.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
from ethgreen_blockchain.ethgreen.util.condition_tools import parse_sexp_to_conditions
from ethgreen_blockchain.ethgreen.util.config import load_config
from ethgreen_blockchain.ethgreen.util.ints import uint16, uint64
from ethgreen_blockchain.ethgreen.util.hash import std_hash
from ethgreen_blockchain.ethgreen.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from ethgreen_blockchain.ethgreen.util.keychain import mnemonic_to_seed
from ethgreen_blockchain.ethgreen.util.byte_types import hexstr_to_bytes
from ethgreen_blockchain.ethgreen.wallet.wallet import Wallet
from ethgreen_blockchain.ethgreen.wallet.derive_keys import master_sk_to_farmer_sk
from ethgreen_blockchain.ethgreen.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    puzzle_for_pk,
