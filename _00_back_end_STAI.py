...
try: sys.path.append(path.join(sys._MEIPASS, 'staicoin_blockchain'))
except: sys.path.append(path.join(path.dirname(__file__), 'staicoin_blockchain'))
...
from blspy import G1Element,\
    ...
    G2Element,\
    PublicKeyMPL
from staicoin_blockchain.staicoin.consensus.cost_calculator import calculate_cost_of_program
from staicoin_blockchain.staicoin.consensus.default_constants import DEFAULT_CONSTANTS
from staicoin_blockchain.staicoin.full_node.bundle_tools import simple_solution_generator
from staicoin_blockchain.staicoin.full_node.mempool_check_conditions import get_name_puzzle_conditions
from staicoin_blockchain.staicoin.rpc.full_node_rpc_client import FullNodeRpcClient
from staicoin_blockchain.staicoin.types.announcement import Announcement
from staicoin_blockchain.staicoin.types.blockchain_format.coin import Coin
from staicoin_blockchain.staicoin.types.blockchain_format.program import Program, SerializedProgram
from staicoin_blockchain.staicoin.types.coin_record import CoinRecord
from staicoin_blockchain.staicoin.types.coin_solution import CoinSolution
from staicoin_blockchain.staicoin.types.condition_opcodes import ConditionOpcode
from staicoin_blockchain.staicoin.types.blockchain_format.sized_bytes import bytes32
from staicoin_blockchain.staicoin.types.spend_bundle import SpendBundle
from staicoin_blockchain.staicoin.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
from staicoin_blockchain.staicoin.util.condition_tools import parse_sexp_to_conditions
from staicoin_blockchain.staicoin.util.config import load_config
from staicoin_blockchain.staicoin.util.ints import uint16, uint64
from staicoin_blockchain.staicoin.util.hash import std_hash
from staicoin_blockchain.staicoin.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from staicoin_blockchain.staicoin.util.keychain import mnemonic_to_seed
from staicoin_blockchain.staicoin.util.byte_types import hexstr_to_bytes
from staicoin_blockchain.staicoin.wallet.wallet import Wallet
from staicoin_blockchain.staicoin.wallet.derive_keys import master_sk_to_farmer_sk
from staicoin_blockchain.staicoin.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    puzzle_for_pk,
